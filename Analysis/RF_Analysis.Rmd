...
```{r T test}
t.test(BF1a.comp, RF1a.comp, paired = TRUE)
t.test(midpoint, BF1a.comp, paired = FALSE)
t.test(midpoint, RF1a.comp, paired = FALSE)
```
