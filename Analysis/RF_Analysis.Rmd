...
t.test(midpoint, BFS3.OK, paired = FALSE)
t.test(midpoint, RFS3.OK, paired = FALSE)
...
#laptop
Study4rawdataset <- read.csv("C:/Users/Julisa/Documents/RFBF/RFBF.repo/Data/Study4_Random.csv", header = T, sep = ",", na=-99, stringsAsFactors = FALSE)
...
t.test(midpoint, BFS4.comp, paired = TRUE)
t.test(midpoint, RFS4.comp, paired = TRUE)
```
