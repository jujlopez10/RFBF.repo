...
t.test(midpoint, BFS2.OK, paired = FALSE)
t.test(midpoint, RFS2.OK, paired = FALSE)
...
NRM.df <- as.data.frame(NRM.r)

RM_1 <- dplyr::coalesce(BRM.df$RacismMini_1, NRM.df$RacismMini_1.1)
RM_2 <- dplyr::coalesce(BRM.df$`RacismMini_2-`, NRM.df$`RacismMini_2.1-`)
RM_3 <- dplyr::coalesce(BRM.df$RacismMini_3, NRM.df$RacismMini_3.1)
RM_4 <- dplyr::coalesce(BRM.df$`RacismMini_4-`, NRM.df$`RacismMini_4.1-`)
RM_5 <- dplyr::coalesce(BRM.df$`RacismMini_5-`, NRM.df$`RacismMini_5.1-`)
RM_6 <- dplyr::coalesce(BRM.df$`RacismMini_6-`, NRM.df$`RacismMini_6.1-`)
RM_7 <- dplyr::coalesce(BRM.df$`RacismMini_7-`, NRM.df$`RacismMini_7.1-`)
RM_8 <- dplyr::coalesce(BRM.df$RacismMini_8, NRM.df$RacismMini_8.1)
RM_9 <- dplyr::coalesce(BRM.df$RacismMini_9, NRM.df$RacismMini_9.1)
RM_10 <- dplyr::coalesce(BRM.df$RacismMini_10, NRM.df$RacismMini_10.1)

RM_S2.df <- data.frame(RM_1, RM_2, RM_3, RM_4, RM_5, RM_6, RM_7, RM_8, RM_9, RM_10)

RM <- multicon::composite(RM_S2.df,
  rel = TRUE, 
  nomiss = 0.6)
...
M <- RM
Y <- OK
Data <- data.frame(X=Study2rawdataset$Condition, Y=OK, M=RM)
